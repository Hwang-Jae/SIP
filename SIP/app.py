...
def get_ch_client():
    ...
    return clickhouse_connect.get_client(
        ...
        connect_timeout=30,       # 초기 대기 시간 단축하여 멈춤 현상 방지
...
<head>
    ...
    <!-- Bootstrap CSS - 깨졌던 CDN 링크가 복구되었습니다 -->
...
<body class="bg-light">
    ...
    <!-- Bootstrap JS - 깨졌던 CDN 링크가 복구되었습니다 -->
...
def chat():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # gpt-oss:20b와 같은 대형 오픈소스 모델의 예기치 않은 JSON 출력 형식을 보장하기 위한 정규식 파서 탑재
